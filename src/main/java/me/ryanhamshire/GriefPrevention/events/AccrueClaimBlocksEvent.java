...
/**
 * Called when GP is about to deliver claim blocks to a player (~every 10
 * minutes)
 *
 * @author RoboMWM 11/15/2016.
 */
public class AccrueClaimBlocksEvent extends Event {
	...
	/**
	 * @return amount of claim blocks GP will deliver to the player for this 10
	 *         minute interval
	 */
	...
	/**
	 * @return whether the player was detected as idle (used for idle accrual
	 *         percentage)
	 */
	...
	/**
	 * Modify the amount of claim blocks to deliver to the player for this 10 minute
	 * interval
	 * 
	...
	/**
	 * Similar to setBlocksToAccrue(int), but automatically converting from a
	 * per-hour rate value to a 10-minute rate value
	 * 
