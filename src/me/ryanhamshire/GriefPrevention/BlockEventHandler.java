...
public class BlockEventHandler implements Listener 
{
	...
	public void onBlockPlace(BlockPlaceEvent placeEvent)
	{
		...
		else if(((block.getType() == Material.OAK_SAPLING) || (block.getType() == Material.SPRUCE_SAPLING) || (block.getType() == Material.BIRCH_SAPLING) || (block.getType() == Material.JUNGLE_SAPLING) || (block.getType() == Material.ACACIA_SAPLING) || (block.getType() == Material.DARK_OAK_SAPLING)) && GriefPrevention.instance.config_blockSkyTrees && GriefPrevention.instance.claimsEnabledForWorld(player.getWorld()))
		{
